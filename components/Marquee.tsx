...
export function Marquee() {
  ...
  return (
    <section
      className="luxury-marquee marquee-section relative overflow-hidden border-y border-line-white bg-bg py-5 md:py-6"
      aria-label="Hizmet sektörleri"
    >
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-gradient-to-r from-[#050505] to-transparent md:w-24" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-gradient-to-l from-[#050505] to-transparent md:w-24" />
